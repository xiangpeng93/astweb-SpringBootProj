...
<script>
  ...
  AddActiveInfo: function () {
	...
	var htmlobj=$.ajax({ type: 'GET',url:submitUrl,dataType:'json',data: {id:this.id,activeHead:$("#active_name").val(),activeAuthor:this.getCookie("userId"),activeUserCount:$("#active_number").val(),activeBody:editor2.txt.html()},async:false});
